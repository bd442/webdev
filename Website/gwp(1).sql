...
--
-- Host: localhost
-- Generation Time: Sep 26, 2014 at 04:56 PM
...
-- Database: `gwp`
--
CREATE DATABASE IF NOT EXISTS `gwp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gwp`;
...
DROP TABLE IF EXISTS `gwp_LoginAttempts`;
...
DROP TABLE IF EXISTS `gwp_medway_campus_chp_data`;
...
DROP TABLE IF EXISTS `gwp_users`;
